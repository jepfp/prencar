 ...
 * <tr><td>103</td><td>Measure battery voltage and send.</td><td></td><td>Measures the current battery voltage and returns it's value over the serial interface.</td></tr>
